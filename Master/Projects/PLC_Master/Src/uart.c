...
void UART_send(char* buffer)
{
	...
	// Send buffer content
	HAL_UART_Transmit(&uart_handle, (uint8_t*) buffer, buffer_len, 4);
...
void uart_init()
{
	...
	HAL_UART_Receive_IT(&uart_handle, RX_buffer, RXBUFFERSIZE);
...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart)
{
	...
	HAL_UART_Receive_IT(huart, RX_buffer, RXBUFFERSIZE);
